...
const designProjects = [
    ...
    {
        title: "Pacific Stormwater Consulting Logo",
        source: psc,
    ...
    {
        title: "North Cascades Christian Fellowship Programs",
        source: nccf,
